            ...
            <div id="invite-{invitation.id}" class="input-group-lg flex flex-col-reverse gap-3 lg:flex-row bg-base-200 p-3 mb-3">
                <div class="flex">
                    ...
                    <form class="flex-grow" method="post" action="?/rejectInvite">
                        <input id="userInviteId-{invitation.id}" hidden={true} name="userInviteId" bind:value={invitation.id} />
                        <button class="btn btn-accent text-xl me-3 w-full" type="submit">
                ...
                <div class="flex">
                    <div class="text-xl text-center label text-primary me-2 btn btn-outline btn-active">
                        <div>
                    ...
                    <div class="flex flex-row me-3 text-xl label">
                        ...
                        <div>
                            <a class="email text-info underline" href="mailto:{invitation.sender.email}">{invitation.sender.email}</a>
                        </div>
                    </div>
                </div>
            </div>
