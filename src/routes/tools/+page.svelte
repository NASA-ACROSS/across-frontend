    ...
    <section class="container pb-5 mb-md-2 mb-lg-4">
        <div class="row gy-4">
            ...
            <div class="col-lg-9">
                ...
                <p class="mb-4 pb-2">
                    Supporting research in science and technology is an
                    important part of NASA's overall mission. NASA solicits this
                    research through the release of various research
                    announcements in a wide range of science and technology
                    disciplines. Basic and applied research in support of NASA’s
                    Science Mission Directorate (SMD) is solicited through the
                    Research Opportunities in Space and Earth Sciences (ROSES)
                    research announcement (NRA). Through this ROSES NRA, NASA
                    ...
                    research opportunities that allows NASA’s space and Earth
                    science programs realize the Strategic Objectives of NASA
                    and the SMD.
                </p>
                ...
                <p class="mb-0 pb-0">
                    Real-time messaging systems are pivotal in enabling
                    multimessenger astronomy by facilitating the rapid and
                    efficient sharing of observational data across the global
                    scientific community. These systems provide prompt
                    notifications of transient astrophysical events, such as
                    gamma-ray bursts, gravitational waves, and neutrino
                    detections, allowing astronomers to coordinate observations
                    using various instruments and across different wavelengths.
                    This timely dissemination of information is crucial for
                    capturing fleeting signals and gaining a comprehensive
                    understanding of the dynamic and often elusive phenomena in
                    the universe.
                </p>

                <div
                    class="row row-cols-2 row-cols-md-2 g-4 pt-2 pt-md-4 pb-lg-2 mb-5"
                >
                    <!-- Item -->
                    <div class="col">
                        <div
                        ...
                        >
                            ...
                            >
                                <h3
                                    class="h6 mb-2 mt-n4 mt-sm-0 mt-md-n4 mt-xxl-0"
                                >
                                    The General Coordinates Network
                                </h3>
                                <p class="fs-sm mb-1">
                                    The General Coordinates Network (GCN) is a
                                    public collaboration platform run by NASA
                                    for the astronomy research community to
                                    share alerts and rapid communications about
                                    high-energy, multimessenger, and transient
                                    phenomena.
                                </p>
                                <a
                                ...
                                >
                                    Visit gcn.nasa.gov
                                    <i class="bx bx-right-arrow-alt fs-xl ms-1"
                                    ></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        ...
                        >
                            ...
                            >
                                ...
                                <p class="fs-sm mb-1">
                                    Hop.SCIMMA is an NSF funded hub providing
                                    real-time streams of candidate discoveries
                                    from MMA experiments. Hop.SCIMMA allows
                                    observatories to publish streams of
                                    candidates and discoveries, and scientists,
                                    brokers, and TOMs to subscribe to these
                                    streams.
                                </p>
                                <a
                    ...
                    <div class="col">
                        ...
                        >
                            ...
                            >
                                ...
                                <p class="fs-sm mb-1">
                                    Email notices for the reporting new
                                    astronomical observations of transient
                                    sources.
                                </p>
                                <a
                ...
                <p class="mb-0 pb-0">
                    ...
                    Astrophysics (WoU-MMA) is one of the 10 Big Ideas that will
                    drive NSF’s long-term research agenda.
                </p>
                        ...
                        >
                            ...
                            >
                                <h3
                                    class="h6 mb-2 mt-n4 mt-sm-0 mt-md-n4 mt-xxl-0"
                                >
                                    Neil Gehrels Swift Observatory Guest
                                    Investigator Program
                                </h3>
                                <p class="fs-sm mb-1">
                                    Cycle 19 proposals are due Thursday,
                                    September 22, 2022
                                </p>
                                <a
                    ...
                    <div class="col">
                        ...
                        >
                            ...
                            >
                                ...
                                <p class="fs-sm mb-1">
                                    Cycle 30 1st Mid-Cycle proposals due
                                    September 30, 2022
                                </p>
                                <a
