<html lang="en">
  ...
  <body>
    ...
    <main class="page-wrapper">
      <!-- Page image (parallax) -->
      <!-- <div class="jarallax mb-lg-5 mb-4" data-jarallax data-speed="0.35" style="height: 30.45vw; min-height: 300px;">
        <div class="jarallax-img" style="background-image: url(assets/img/custom/729665main_A-BlackHoleArt-pia16695_full.jpg);"></div>
      </div>   -->
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <p class="" style="max-width: 600px;">
                The very nature of multimessenger and time domain astronomy
                calls for the coordination of resources and expertise from
                diverse domains of astrophysics, cosmology, and physics to
                correlate and interpret data from multiple messengers to enable
                further groundbreaking discoveries. Progress in this field
                depends on many stakeholders working together efficiently - not
                only scientists from the astronomy and physics, ground- and
                space-based communities, but also engineers, software
                developers, data and communication scientists, and more. This
                paradigm shift in astronomical research, thus, depends as much
                on technological advancements and scientific acumen as on the
                collaboration, communication, and infrastructure frameworks that
                are in place to enable such multifaceted exploration of the
                universe. The vision at the core of Astrophysics
                Cross-Observatory Science Support (ACROSS) center is the
                recognition that progress in MMA/TDA science can only be
                achieved if all stakeholders Communicate (often and regularly),
                Coordinate (plan and execute together), and Collaborate (share
                ideas and tools) - the three Cs. The challenges to MMA/TDA of
                the 21st century, with the improved sensitivities of ground- and
                space-based facilities, require nothing less.
              </p>

              <!-- <p class="pb-4 mb-1 mb-md-2 mb-lg-3" style="max-width: 600px;">MOSSAIC is an initiative of two NASA Centers (Goddard and Marshall Space Flight Centers), with a vision to include other stakeholders from Universities, government Labs, non-profits, and industry as active partners. It brings together current research, capabilities, and resources needed to support MMA/TDA scientists around the world. MOSSAIC is primarily intended as a service to the community, to facilitate connections between ground- and space-based observers, theorists, and data scientists from the astronomy and physics fields. It also aims to provide data analysis and interpretation tools, observations planning capabilities, proposal preparation and submission support, mission concept development, and more. Each MOSSAIC partner has equal weight and provides unique contributions, and has pledged to work with the others while maintaining their identity and autonomy.</p> -->
            </div>
      ...
      <!-- Contact CTA -->
      <section
        class="container pt-2 pb-4 pb-md-5 pb-5 mt-0"
          ...
          >
            <div class="py-md-5 py-4 text-center">
              <h3 class="h4 fw-normal text-light opacity-75">
                Interested in contributing to the ACROSS effort?
              </h3>
              <a
