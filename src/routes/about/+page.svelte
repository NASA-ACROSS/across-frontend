...
<Section title="System Overview">
    <div class="border-t border-base-300 pt-3 space-y-3">
        <p class="leading-relaxed">
            ...
            empowers scientists to make informed decisions about observation planning, coordination, and execution.
        </p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
            <div class="bg-base-200 p-4 space-y-2">
                <div class="text-primary">
                    <i class="bx bx-analyze text-2xl"></i>
                </div>
                <p class="font-semibold">Aggregated Data</p>
                <p class="text-sm leading-relaxed">Normalizes schedule and observation data from multiple missions into a single, consistent data model.</p>
            </div>
            <div class="bg-base-200 p-4 space-y-2">
                <div class="text-primary">
                    <i class="bx bx-search-alt text-2xl"></i>
                </div>
                <p class="font-semibold">Unified Query Interface</p>
                <p class="text-sm leading-relaxed">A single API to query across all supported observatories, telescopes, and instruments simultaneously.</p>
            </div>
            <div class="bg-base-200 p-4 space-y-2">
                <div class="text-primary">
                    <i class="bx bx-calendar-check text-2xl"></i>
                </div>
                <p class="font-semibold">Observing Tools</p>
...
<Section title="Open Data Policy" icon="lock-open-alt">
    <div class="border-t border-base-300 pt-3 space-y-3">
        <p class="leading-relaxed">
            ...
            >
            All <code class="bg-base-200 px-1 text-sm">GET</code> endpoints are publicly accessible without authentication, allowing anyone to query schedules, observations,
