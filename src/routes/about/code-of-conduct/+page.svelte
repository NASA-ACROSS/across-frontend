    ...
    <div class="border-t border-base-300 pt-3 space-y-8">
        <Section title="Community Pledge">
            <p class="leading-relaxed">
                In the interest of fostering an open and welcoming environment, contributors and maintainers pledge to make participation in
                the ACROSS project and the community a harassment-free experience for everyone, treating all with equal dignity and respect.
            </p>
        </Section>
        ...
        <Section title="Enforcement">
            <p class="leading-relaxed">
                Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to NASA ACROSS. All complaints will be
                reviewed and investigated and will result in a response that is deemed necessary and appropriate to the circumstances. The
                project team is obligated to maintain confidentiality with regard to the reporter of an incident. Further details of
