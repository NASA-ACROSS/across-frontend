<script>
  ...
  const blogPostsSliderOptions = JSON.stringify({
    slidesPerView: 1,
    spaceBetween: 8,
    pagination: {
  ...
  const testimonialsSliderOptions = JSON.stringify({
    spaceBetween: 24,
    loop: true,
    pagination: {
      el: ".swiper-pagination",
    ...
    <main class="page-wrapper">
        ...
        <div class="container position-relative pb-5 zindex-5">
          ...
          <div class="row mb-xxl-5 py-md-4 py-lg-5">
            ...
            >
              ...
              >
                Multimessenger and time-domain astrophysics are opening entirely
                new windows on the Universe. The Astrophysics Cross-Observatory
                Science Support (ACROSS) center is an initiative to facilitate
                communication, coordination, and collaboration in this new era
                of astronomy.
              </p>
            </div>
          </div>
        ...
        <div class="row pt-2 pt-md-3">
          <div class="col-md-6">
            <p class="pe-lg-4 mb-1 mb-lg-4">
              ...
              messengers that make up multimessenger astronomy are
              electromagnetic radiation, gravitational waves, neutrinos, and
              cosmic rays and the primary multimessenger sources outside the
              heliosphere are expected to be compact binary pairs (black holes
              and neutron stars), supernovae, irregular neutron stars, gamma-ray
              bursts, active galactic nuclei, and relativistic jets. The present
              study of the these multimessenger sources has become one of the
              most promising discovery areas of modern astronomy. Identified as
              one of the central themes of the 2020 Decadal Review, the full
              realization of time-domain and multi-messenger astronomy now
              stands to open an entirely new window on the Universe.
            </p>

            <p>
              The first joint detection of two merging neutron stars in
              gravitational waves and electromagnetic radiation on August 17,
              2017 was a watershed moment for the field of multimessenger
              astronomy. The information gained from the detection of both
              messengers enable science that would have been impossible to
              perform with either signal alone. The discovery demonstrated that
              multimessenger astrophysics offers a powerful methodology of
              growing importance, as astronomers combine electromagnetic
              radiation, gravitational wave radiation, and particle astrophysics
              observations of cosmic events.
            </p>
          ...
          <div class="col-md-7">
            <div class="card border-0 shadow-sm p-4 p-xxl-5">
              ...
              <div
                ...
                data-swiper-options={testimonialsSliderOptions}
              >
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide h-auto">
                    ...
                    >
                      <blockquote class="card-body p-0 mb-0">
                        <p class="fs-lg mb-0">
                          The New Messengers and New Physics theme embodies the
                          dual revolutions brought about by the marriage of
                          observations of light with those from gravitational
                          waves and elementary particles (multi-messenger
                          astrophysics) along with the expansion of measurements
                          of the sky over time (time-domain).
                        </p>
                      </blockquote>
                      <figcaption
                  ...
                  <div class="swiper-slide h-auto">
                    ...
                    >
                      <blockquote class="card-body p-0 mb-0">
                        <p class="fs-lg mb-0">
                          In space, the highest-priority sustaining activity is
                          a space-based time-domain and multi-messenger program
                          of small and medium-scale missions.
                        </p>
                      </blockquote>
                      <figcaption
                        class="card-footer border-0 d-flex align-items-center w-100 pb-2"
                      >
                        ...
                        <div class="ps-3">
                          ...
                          <span class="fs-sm text-muted">Page S-3</span>
                        </div>
                      </figcaption>
                    </figure>
                  </div>
      ...
      <section class="container mt-4 pt-lg-2 pb-4">
        ...
        <div
          ...
          data-swiper-options={blogPostsSliderOptions}
        >
          <div class="swiper-wrapper">
            <!-- Item -->
                ...
                <div class="card-body pb-0">
                  ...
                  >
                    <a
                      ...
                      >Soliciations</a
                    >
                    <span class="fs-sm text-muted">Aug 16, 2022</span>
                  </div>
                  <h3 class="h4">
                    <a
                      href="https://www.nasa.gov/press-release/nasa-selects-proposals-to-study-stellar-explosions-galaxies-stars"
                      class="stretched-link"
                      >2023 Astrophysics Probe Explorer (APEX) draft
                      announcement released</a
                    >
                  </h3>
                  <p class="mb-0">
                    Astrophysics Probe Explorer (APEX) AO Community Announcement
                    release of draft solicitation
                  </p>
                </div>
              </article>
            </div>
                ...
                <div class="card-body pb-0">
                  ...
                  >
                    <a
                      ...
                      >Swift</a
                    >
                    <span class="fs-sm text-muted">Feb 18, 2022</span>
                  </div>
                  <h3 class="h4">
                    <a
                      href="https://swift.gsfc.nasa.gov/news/2022/safe_mode.html"
                      class="stretched-link"
                      >NASA's Swift Observatory Returns to Science</a
                    >
                  </h3>
                  <p class="mb-0">
                    NASA's Neil Gehrels Swift Observatory successfully returned
                    to science operations Thursday, Feb. 17. The spacecraft and
                    its three instruments are healthy and operating as expected.
                  </p>
                </div>
              </article>
            </div>
                ...
                <div class="card-body pb-0">
                  ...
                  >
                    <a
                      ...
                      >Swift</a
                    >
                    <span class="fs-sm text-muted">Feb 15, 2022</span>
                  </div>
                  <h3 class="h4">
                    <a
                      href="https://swift.gsfc.nasa.gov/proposals/c18_acceptarg.html"
                      class="stretched-link">Swift Cycle 18 Results</a
                    >
                  </h3>
                  <p class="mb-0">
                    Swift Cycle 18 Recommended Targets and Proposals have been
                    posted.
                  </p>
                </div>
              </article>
      ...
      <section class="container mt-4 mb-lg-5 pt-lg-2 pb-5">
        <div class="row align-items-end gy-3 mb-4 pb-lg-3 pb-1">
          <div class="col-lg-5 col-md-4">
            <h1 class="mb-2 mb-md-0">Science Highlights</h1>
          </div>
        </div>
          ...
          <div class="col pb-3">
            <article class="card border-0 shadow-sm h-100">
              <div class="position-relative">
                ...
                ></a>
                <img
                  src="assets/img/custom/hubble_mrk1337_esapotw2145a_0.jpg"
                  class="card-img-top"
                  alt="Image"
                />
              </div>
              <div class="card-body pb-4">
                ...
                >
                  <a
                    ...
                    >Mission Selections</a
                  >
                  <span class="fs-sm text-muted">Aug 18, 2022</span>
                </div>
                <h3 class="h5 mb-0">
                  <a
                    href="https://www.nasa.gov/press-release/nasa-selects-proposals-to-study-stellar-explosions-galaxies-stars"
                    >NASA Selects Proposals to Study Stellar Explosions,
                    Galaxies, Stars</a
                  >
                </h3>
              </div>
          ...
          <div class="col pb-3">
            <article class="card border-0 shadow-sm h-100">
              <div class="position-relative">
                ...
                ></a>
                <img
                  src="assets/img/custom/jwst_deepfield.png"
                  class="card-img-top"
                  alt="Image"
                />
              </div>
              <div class="card-body pb-4">
                ...
                >
                  <a
                    ...
                    >James Webb</a
                  >
                  <span class="fs-sm text-muted">Jul 12, 2022</span>
                </div>
                <h3 class="h5 mb-0">
                  <a
                    href="https://www.nasa.gov/press-release/nasa-reveals-webb-telescope-s-first-images-of-unseen-universe"
                    >First Images from the James Webb Space Telescope</a
                  >
                </h3>
              </div>
            </article>
          ...
          <div class="col pb-3">
            <article class="card border-0 shadow-sm h-100">
              <div class="position-relative">
                ...
                ></a>
                <img
                  src="assets/img/custom/PeVatron.png"
                  class="card-img-top"
                  alt="Image"
                />
              </div>
              <div class="card-body pb-4">
                ...
                >
                  <a
                    ...
                    >Cosmic-rays</a
                  >
                  <span class="fs-sm text-muted">Aug 10, 2022</span>
                </div>
                <h3 class="h5 mb-0">
                  <a
                    href="https://www.nasa.gov/feature/goddard/2022/nasa-s-fermi-confirms-star-wreck-as-source-of-extreme-cosmic-particles"
                    >NASA’s Fermi Confirms Star Wreck as Source of Extreme
                    Cosmic Particles</a
                  >
                </h3>
              </div>
          ...
          <div class="col pb-3">
            <article class="card border-0 shadow-sm h-100">
              <div class="position-relative">
                ...
                ></a>
                <img
                  src="assets/img/custom/Fermi_Blackhole2.png"
                  class="card-img-top"
                  alt="Image"
                />
              </div>
              <div class="card-body pb-4">
                ...
                >
                  <a
                    ...
                    >Gamma-rays</a
                  >
                  <span class="fs-sm text-muted">Apr 7, 2022</span>
                </div>
                <h3 class="h5 mb-0">
                  <a
                    href="https://www.nasa.gov/feature/goddard/2022/nasa-s-fermi-hunts-for-gravitational-waves-from-monster-black-holes"
                    >NASA’s Fermi Hunts for Gravitational Waves From Monster
                    Black Holes</a
                  >
                </h3>
              </div>
              ...
              <div class="card-body pb-4">
                ...
                >
                  <a
                    ...
                    >Neutrinos</a
                  >
                  <span class="fs-sm text-muted">Jul 12, 2018</span>
                </div>
                <h3 class="h5 mb-0">
                  <a
                    href="https://www.nasa.gov/press-release/nasa-s-fermi-traces-source-of-cosmic-neutrino-to-monster-black-hole/"
                    >NASA’s Fermi Traces Source of Cosmic Neutrino to Monster
                    Black Hole</a
                  >
                </h3>
              </div>
              ...
              <div class="card-body pb-4">
                ...
                >
                  <a
                    ...
                    >Neutrinos</a
                  >
                  <span class="fs-sm text-muted">Feb 22, 2021</span>
                </div>
                <h3 class="h5 mb-0">
                  <a
                    href="https://www.nasa.gov/feature/goddard/2021/nasa-s-swift-helps-tie-neutrino-to-star-shredding-black-hole"
                    >NASA’s Swift Helps Tie Neutrino to Star-shredding Black
                    Hole</a
                  >
                </h3>
              </div>
      ...
      <section class="container">
        <!-- Sign up CTA -->
        <div
          class="bg-secondary rounded-3 my-2 my-md-4 my-lg-5 py-5 px-3 px-md-0"
        >
          <div class="row align-items-center">
            <div
              class="col-md-5 offset-lg-1 text-center text-md-start ps-md-5 ps-lg-0 ps-xl-5 pb-2 pb-md-0 mb-4 mb-md-0"
            >
              <p class="lead mb-3">Interested in contributing to this page?</p>
              <h2 class="h1 pb-2 pb-md-4">
                Take Your <span class="text-primary">Skills</span> to the Next Level
              </h2>
              <a href="#" class="btn btn-primary btn-lg"
                >Check out our Git Repo!</a
              >
            </div>
