...
<div class="space-y-8">
    ...
    <section class="space-y-3">
        ...
        <p class="text-base leading-relaxed">Examples of unacceptable behavior by participants include:</p>
        <ul class="list-disc list-inside space-y-1 ml-2 text-base leading-relaxed">
    ...
    <!-- Scope -->
    <section class="space-y-3">
        <h3 class="text-2xl font-semibold text-primary border-b border-base-300 pb-2">Scope</h3>
        <p class="text-base leading-relaxed">
    ...
    <!-- Attribution -->
    <section class="space-y-2">
        <h3 class="text-2xl font-semibold text-primary border-b border-base-300 pb-2">Attribution</h3>
        <p class="text-base leading-relaxed">
